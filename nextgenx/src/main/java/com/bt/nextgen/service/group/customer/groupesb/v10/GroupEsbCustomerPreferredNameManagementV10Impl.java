...
@Service("preferredNameManagementV10Service")
public class GroupEsbCustomerPreferredNameManagementV10Impl implements CustomerDataManagementIntegrationService
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(GroupEsbCustomerPreferredNameManagementV10Impl.class);
   @Override
   public CustomerData retrieveCustomerInformation(CustomerManagementRequest request, List<String> operationTypes, ServiceErrors serviceErrors) {
       ...
       if(request != null && request.getInvolvedPartyRoleType()!= null && !request.getOperationTypes().isEmpty() && request.getCISKey()!=null) {
           ...
           return CustomerManagementDataV10Converter.convertResponseToPreferredNameModel(response);
       }
    ...
    public boolean updateCustomerInformation(CustomerData updatedData, ServiceErrors serviceErrors) {
        ...
        ModifyIndividualCustomerRequest requestPayload = GroupEsbPreferredNameUpdateRequestV10Builder.createModifyIndividualCustomerRequest(updatedData, cachedResponse);
