package com.bt.nextgen.service.group.customer.groupesb.email.v7;
...
public final class GroupEsbCustomerContactDetailsRequestV7Builder {

    private GroupEsbCustomerContactDetailsRequestV7Builder() {}

    private static final Logger logger = LoggerFactory.getLogger(GroupEsbCustomerContactDetailsRequestV7Builder.class);
    ...
    public static MaintainIPContactMethodsRequest createContactDetailsModificationRequest(
        ...
        for (Email  email : customerData.getEmails()) {
            if(email instanceof CustomerEmailV7 && ((CustomerEmailV7) email).getAction() != null) {
                i += 1;
                String rowSetIdentifier = String.format("%010d", i);
                CustomerEmailV7 customerEmail = (CustomerEmailV7) email;
    ...
    private static List<PhoneAddressContactMethod> createRequestForPhoneAddress(CustomerData customerData, RetrieveDetailsAndArrangementRelationshipsForIPsResponse cachedResponse){
        return CustomerPhoneUpdateV7Converter.convertResponseInPhone(customerData, cachedResponse);
    }
    ...
    private static void requestSettingsForEmailDelete(EmailAddressContactMethod emailAddressContactMethod, au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
            retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod cachedEmailContexts, String rowSeq, ObjectFactory objectFactory) {
    ...
    private static void requestSettingsForEmailModify(EmailAddressContactMethod emailAddressContactMethod, au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
            retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod cachedContextMethod, String roSeqNo, ObjectFactory objectFactory) {
    ...
    private static String getFullNameFromCachedResponse(RetrieveDetailsAndArrangementRelationshipsForIPsResponse cachedResponse) {
        ...
        for (au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
                retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod emailAddressContactMethod :
    ...
    private static Map<String, au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
            retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod>
    ...
    private static Map<String, au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
            retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod> getCachedEmailContextsIntoAMap(
            List<au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
                    retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod> contextList) {

        Map<String, au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
                retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod> retrievedEmailsMap =
                new HashMap<>();
        for (au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.
                retrievedetailsandarrangementrelationshipsforips.v7.svc0258.EmailAddressContactMethod
