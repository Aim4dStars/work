...
public final class GroupEsbPreferredNameUpdateRequestV10Builder
{
    private GroupEsbPreferredNameUpdateRequestV10Builder(){}
    ...
    protected static void populateAlternateNames(CustomerData customerData,RetrieveDetailsAndArrangementRelationshipsForIPsResponse cachedResponse,
        ...
        au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.retrievedetailsandarrangementrelationshipsforips.v10.svc0258.AlternateName cachedName = null;
        List<au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.retrievedetailsandarrangementrelationshipsforips.v10.svc0258.AlternateName>
                names = cachedResponse.getIndividual().getHasForName().getHasAlternateName();

        if(!names.isEmpty()) {
            for (au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.retrievedetailsandarrangementrelationshipsforips.v10.svc0258.AlternateName name : names) {
    ...
    private static AlternateName getEndAlternateName(
            ObjectFactory of,
            au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.retrievedetailsandarrangementrelationshipsforips.v10.svc0258.AlternateName cachedName) {
        AlternateName alternateName = of.createAlternateName();
        alternateName.setIsPreferred("N");
        alternateName.setName(cachedName.getName());
        alternateName.setStartDate(cachedName.getStartDate().getValue());
