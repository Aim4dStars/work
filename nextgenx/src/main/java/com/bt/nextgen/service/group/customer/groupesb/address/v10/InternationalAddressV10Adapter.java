 ...
 */
public class InternationalAddressV10Adapter extends AddressAdapterV10{

    private NonStandardPostalAddress nonStandardPostalAddress;
    private static final String AUSTRALIA_COUNTRY_CODE = "AU";

    public InternationalAddressV10Adapter(NonStandardPostalAddress nonStandardPostalAddress){
