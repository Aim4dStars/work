...
public final class GroupEsbAddressUpdateRequestV10Builder {

    private static final Logger logger = LoggerFactory.getLogger(GroupEsbAddressUpdateRequestV10Builder.class);

    private GroupEsbAddressUpdateRequestV10Builder(){}
    ...
    public static MaintainIPContactMethodsRequest createUpdateIPContactMethods(CustomerData customerData, RetrieveDetailsAndArrangementRelationshipsForIPsResponse cachedResponse){
        ...
        au.com.westpac.gn.involvedpartymanagement.services.involvedpartymanagement.xsd.retrievedetailsandarrangementrelationshipsforips.v10.svc0258.PostalAddressContactMethod cachedPostalAddress = null;
        if(customerData.getRequest().getInvolvedPartyRoleType().equals(RoleType.INDIVIDUAL)){
            ...
            cachedPostalAddress
                    = CustomerAddressManagementV10Converter.convertResponseInAddressModel(cachedResponse, customerData.getRequest());
        }else{
        ...
        PostalAddressContactMethod address = CustomerAddressUpdateV10Converter.createPostalAddressToBeSentForUpdate(cachedPostalAddress, customerData);
