...
@Service("contactDetailsManagementV7Service")
public class GroupEsbCustomerContactDetailsManagementV7Impl implements CustomerDataManagementIntegrationService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GroupEsbCustomerContactDetailsManagementV7Impl.class);
    ...
    public CustomerData retrieveCustomerInformation(CustomerManagementRequest req, List<String> operationTypes, ServiceErrors serviceErrors) {
        ...
        if(req != null && req.getInvolvedPartyRoleType()!= null && !req.getOperationTypes().isEmpty() && req.getCISKey()!=null) {
            ...
            customerData.setEmails(CustomerManagementDataV7Converter.convertResponseInEmailModel(response).getEmails());
            customerData.setPhoneNumbers(CustomerPhoneV7Converter.convertResponseInPhone(response, req).getPhoneNumbers());
            return customerData;
        }
    ...
    public boolean updateCustomerInformation(CustomerData updatedData, ServiceErrors serviceErrors) {
        ...
        MaintainIPContactMethodsRequest requestPayload = GroupEsbCustomerContactDetailsRequestV7Builder.createContactDetailsModificationRequest(updatedData, cachedResponse);
