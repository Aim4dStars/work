...
public class BTChartTheme implements ChartTheme
{
	...
	public static final Color PAINT_PLOT_DOMAIN_GRID = new Color(0xE7E6E5);
	public static final Color PAINT_PLOT_RANGE_GRID = new Color(0xE7E6E5);

	public static final Color PAINT_PLOT_RANGE_LABEL = new Color(0x838281);
	public static final Color PAINT_PLOT_DOMAIN_LABEL = new Color(0x838281);
	public static final Color PAINT_PLOT_RANGE_TICK_LABEL = new Color(0x838281);
	public static final Color PAINT_PLOT_DOMAIN_TICK_LABEL = new Color(0x838281);
	...
	public static final Font FONT_PLOT_RANGE_LABEL = new Font("Helvetica", Font.BOLD, 9);
	public static final Font FONT_PLOT_DOMAIN_LABEL = new Font("Helvetica", Font.BOLD, 9);
	public static final Font FONT_PLOT_RANGE_TICK_LABEL = new Font("Helvetica", Font.BOLD, 8);
	public static final Font FONT_PLOT_DOMAIN_TICK_LABEL = new Font("Helvetica", Font.BOLD, 8);
	...
	public static final Color PAINT_BAR_POSITIVE = new Color(0x008CC7);
	public static final Color PAINT_BAR_NEGATIVE = new Color(0xDFDEDC);
    ...
    public static final List<Color> PAINT_PLOT_LINE_COLORS = Arrays.asList(new Color(0xffcf1c), new Color(0xea6d00),
            new Color(0xdb235b), new Color(0x672993));

	public static final Color PAINT_BAR_ITEM_LABEL = new Color(0x838281);
	public static final Font FONT_BAR_ITEM_LABEL = new Font("Helvetica", Font.BOLD, 8);

	public static final BasicStroke STROKE_LINE = new BasicStroke(2.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
    public static final BasicStroke STROKE_LINE_THIN = new BasicStroke(1.50f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
	...
	private static final BTChartTheme theme = new BTChartTheme();
