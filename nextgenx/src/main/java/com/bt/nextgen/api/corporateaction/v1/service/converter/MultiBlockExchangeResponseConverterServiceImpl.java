...
@CorporateActionResponseConverter("CA_MULTI_BLOCK_EXCHANGE_RESPONSE")
public class MultiBlockExchangeResponseConverterServiceImpl extends MultiBlockResponseConverterServiceImpl {
    @Override
