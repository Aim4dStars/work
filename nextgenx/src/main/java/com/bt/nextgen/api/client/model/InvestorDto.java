...
public class InvestorDto extends ClientDto {
    ...
    private boolean tfnEntered; // comes from AssociatedPerson mapping, for Trustee TFNs. Similar to tfnProvided, mapping is sorted out in the UI.
    ...
    private Boolean overseasTaxResident;
    ...
    public Boolean getOverseasTaxResident() {
        return overseasTaxResident;
    }

    public void setOverseasTaxResident(Boolean overseasTaxResident) {
        this.overseasTaxResident = overseasTaxResident;
    }
