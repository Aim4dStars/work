...
public class TermDepositTradeAssetDtoV2 extends TradeAssetDto {
    private static final double COMPARISON_AMOUNT = 10000d;

    private final String termDisplay;
    private final String description;

    public TermDepositTradeAssetDtoV2(TermDepositAssetDtoV2 tdAsset, boolean buyable, boolean sellable) {
    ...
    public BigDecimal getIndicativeRate() {
        if (this.getAsset() instanceof TermDepositAssetDtoV2) {
            TermDepositAssetDtoV2 tdAsset = (TermDepositAssetDtoV2) this.getAsset();
