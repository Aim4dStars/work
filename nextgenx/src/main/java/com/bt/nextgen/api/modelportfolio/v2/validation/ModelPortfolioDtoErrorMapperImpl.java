package com.bt.nextgen.api.modelportfolio.v2.validation;
...
@Service
@SuppressWarnings("squid:S1168") // Required by api
public class ModelPortfolioDtoErrorMapperImpl implements ModelPortfolioDtoErrorMapper
{
	@Override
