...
@CorporateActionResponseConverter("CA_MULTI_BLOCK_CONVERSION_RESPONSE")
public class MultiBlockConversionResponseConverterServiceImpl extends MultiBlockResponseConverterServiceImpl {
    @Override
