...
@Service("TransactionFeeDtoServiceV2")
public class TransactionFeesDtoServiceImpl implements TransactionFeeDtoService {
    ...
    public AssetMappedAccountTransactionFeesDto find(AccountKey accountKey, ServiceErrors serviceErrors) {
        ...
        // get the direct fees
        AssetMappedAccountTransactionFeesDto fees = toAssetMappedTransactionFees(accountKey,
    ...
    private AssetMappedAccountTransactionFeesDto toAssetMappedTransactionFees(AccountKey accountKey,
        ...
        return new AssetMappedAccountTransactionFeesDto(accountKey, mappedTransactionFees);
