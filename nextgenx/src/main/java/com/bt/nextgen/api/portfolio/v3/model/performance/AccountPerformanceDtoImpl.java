...
public class AccountPerformanceDtoImpl extends BaseDto implements AccountPerformanceDto {
    ...
    private List<DateValueDto> portfolioValueSummary;
    ...
    public AccountPerformanceDtoImpl() {
        // initialisation via mutators
    }
    ...
    public void setPortfolioValueSummary(List<DateValueDto> portfolioValueSummary) {
        this.portfolioValueSummary = portfolioValueSummary;
    }
