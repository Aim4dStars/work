...
import com.bt.nextgen.api.portfolio.v3.model.BglDataDto;
import com.bt.nextgen.api.portfolio.v3.model.DateRangeAccountKey;
import com.bt.nextgen.api.portfolio.v3.service.BglDtoService;
...
public class BglApiController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "${api.portfolio.v3.uri.bgl}", produces = "application/xml")
