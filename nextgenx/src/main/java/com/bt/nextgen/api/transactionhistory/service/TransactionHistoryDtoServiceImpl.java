...
public class TransactionHistoryDtoServiceImpl implements TransactionHistoryDtoService {
    @Autowired
    ...
    public List<TransactionHistoryDto> getTransactionHistory(String portfolioId, DateTime startDate, DateTime endDate,
        ...
        List<TransactionHistory> transactions = transactionIntegrationService.loadTransactionHistory(pid, endDate, startDate,
                serviceErrors);
    ...
    private TransactionHistoryDto buildTransactionDto(TransactionHistory transaction) {
        ...
        TransactionHistoryDto transactionDto = new TransactionHistoryDto(transaction, assetDetails, description, amountDetails);
    ...
    private void processLinkedTransactions(List<TransactionHistoryDto> transactionDtos) {
        ...
        for (TransactionHistoryDto dto : transactionDtos) {
            if (dto.getTradeDate() == null || dto.getSettlementDate() == null || dto.getOrderId() == null) {
                dto.setIsLinked(false);
            } else if (previousTransaction == null || !dto.getTradeDate().equals(previousTransaction.getTradeDate())
