...
@Report("orderPreviewReportV2")
public class OrderPreviewReportV2 extends AbstractOrderReportV2 {
    ...
    public String getDeclaration(Map<String, Object> params, Map<String, Object> dataCollections) {
        ...
        OrderGroupReportData orderGroupReportData = getOrderGroupDataV2(params, dataCollections);
