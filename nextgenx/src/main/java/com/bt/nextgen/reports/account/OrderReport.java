...
public class OrderReport extends AbstractOrderReport {
    ...
    public OrderReport(String reportType, String subReportType) {
     ...
     * @return the map
     */
    private Map<String, TermDepositAssetDetail> loadTermDepositRates(EncodedString encodedAccountId, Asset asset) {
        ServiceErrors serviceErrors = new FailFastErrorsImpl();
        ...
        Map<String, TermDepositAssetDetail> termDepositAssetDetails = assetService.loadTermDepositRates(adviser.getDealerKey(),
    ...
    private TermDepositAssetDto generateTermDepositDto(final Asset asset, final Map<String, String> params, OrderItemDto orderItem) {
        ...
        Map<String, TermDepositAssetDetail> termDepositAssetDetails = loadTermDepositRates(encodedAccountId, asset);
