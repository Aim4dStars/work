...
<body class="bodyContainer flexContainer bg-blurred">
    ...
    <div class="layoutContainer BlueContainer">
        ...
        <div class="noticeBox warningBox jq-FormErrorMessage customFormError errorStyle ${messageType=='ERROR' ? '': 'noDisplay'} ">
            <ul class="noticeBoxWrapper">
                <li><span class="messageIcon"><em class="iconItem"></em></span></li>
                <li class="noticeBoxText" role="alert">
                    <span class="noticeDescTxt">${message}</span>
                </li>
            </ul>
        </div>
		...
		<form name="form" data-ajax="false" action="registerUser"
			...
			<fieldset>
				...
				<h3 class="header-statement heading-two">
					<span class="color-white">Reset password</span>
				</h3>	
					
				<ul>
					<li class="margin-bottom-1">
						<div class="bubbleContainer">
							<div class="helpToolBox helpToolBoxPos3 noDisplay jq-passwordResetPasswordPolicyHintsContainer" id="passwordCheckReset"
							...
							<div class="validation-container">
								...
								<input type="password" id="passwordResetNewPassword" name="newpassword"
									...
									data-validation="validate[required,customFunction]"	
										data-validation-required-error="<cms:content name="Err.IP-0329"/>"
					...
					<li class="margin-bottom-2">
						<div data-view-component="inputtext" data-component-name="passwordResetConfirmPassword"
							...
							<div class="validation-container">
								...
								<input
									aria-describedby="passwordCheckReset" type="password"
									id="passwordResetConfirmPassword" placeholder="Repeat password" name="confirmPassword"class="formTextInput jq-passwordResetConfirmPassword"
									maxlength="32" data-validation="validate[required]"
					...
					<li>
						<span data-view-component="button" data-component-name="primaryaction" data-directive-processed="true" class="view-primaryaction">
    						<button type="submit" class="btn-action-primary jq-formSubmit disabled jq-passwordResetStepTwoSubmitButton" name="logon" data-ng-key="signinButton">
						...
						<span data-view-component="button" data-directive-processed="true" class="view-button">
							<a href="/pkmslogout" title="Cancel" class="btn-action-tertiary tempPasswordCancelBtn">
								<span class="button-inner">
