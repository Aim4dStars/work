...
(function( $, undefined ) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _selectMonthYear: function(id, select, period) {
            ...
            var target = $(id);
            var inst = this._getInst(target[0]);
            var currentDataHandler = select.attributes['data-handler'].value;
            ...
            inst.dpDiv.find('[data-handler='+currentDataHandler+']').focus().select();
        ...
        _attachHandlers: function(inst) {
            ...
            inst.dpDiv.find('[data-handler]').map(function () {
                ...
                $(inst.dpDiv).on('keyup', 'select.ui-datepicker-month, select.ui-datepicker-year', function(){ 
                	$(this).trigger('change'); 
                });
