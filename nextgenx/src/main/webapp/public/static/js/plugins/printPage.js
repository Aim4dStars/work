...
(function( $ ){
    $.fn.printPage = function(options) {
        ...
        var components = {
            iframe: function(url){
                return '<iframe id="printPage" name="printPage" aria-hidden="true" style="visibility:visible;display:block;position:absolute;left:-10000px;top:auto;width:1px;height:1px;overflow:hidden; @media print { display: block; }" src='+url+' ></iframe>';
            },
