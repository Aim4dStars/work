...
org.bt.modules.tempPassword = (function($,window,document) {
    ...
    var _bindDOMEvents = function(){
        ...
        org.bt.utils.communicate.ajax.call(this, {
                    'type':'GET',
                    'async': false,
                    'url':org.bt.cryptoUrl +'?uid='+ encodeURIComponent(paramUserName),
    ...
    var _initCrypto = function($form){
        ...
        action  = org.bt.utils.serviceDirectory.forgotPasswordStep2;
        ...
        org.bt.utils.communicate.ajax(
            {
                ...
                onSuccess:function(res){
                    if(res.success){
                        ...
                        //$('.jq-tmpPasswordBusyDialog').dialog( "close" );
                        $('.jq-passwordResetStepTwoSubmitButton').find(".iconWLoader").addClass("noDisplay");
                        $('.jq-passwordResetStepTwoSubmitButton').find(".label-content").removeClass    ("noDisplay");
                        $('.jq-passwordResetStepTwoSubmitButton').removeClass('jq-preventSubmit');
                        $('.jq-passwordResetNewPassword').val('');
                         $('.jq-passwordResetConfirmPassword').val('');
                         $form.addClass('jq-preventSubmit');
                         $('.jq-passwordResetStepTwoSubmitButton').addClass('disabled');
