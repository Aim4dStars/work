...
import com.bt.nextgen.api.client.v2.util.ClientOffThreadDtoConverter;
...
public class ClientOffThreadDtoConverterTest {

    private ClientOffThreadDtoConverter dtoConverter;

    @Before
    public void setUp() {
        dtoConverter = new ClientOffThreadDtoConverter();
    }
