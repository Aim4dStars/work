...
public class CreateOneTimePasswordSendEmailRequestMsgTypeBuilderTest extends AbstractSchemaValidatorTest {
    ...
    private CreateOneTimePasswordSendEmailRequestMsgTypeBuilderV3 builder;
    ...
    public CreateOneTimePasswordSendEmailRequestMsgTypeBuilderTest() {
    ...
    public void initBuilderAndMocks() throws Exception {
        builder = new CreateOneTimePasswordSendEmailRequestMsgTypeBuilderV3();
        ...
        when(clientListDtoService.findWithoutRelatedAccounts(any(ClientKey.class), eq(serviceErrors))).thenReturn(individualDto);
    ...
    public void shouldContainThePartyDetailsContainingTheGcmIdOfTheClient() throws Exception {
        CreateOneTimePasswordSendEmailRequestMsgType request = builder.build(clientId, adviserPositionId, Attribute.INVESTOR, serviceErrors);
    ...
    public void shouldContainThePartyDetailsContainingTheGcmIdOfAdviser() throws Exception {
        CreateOneTimePasswordSendEmailRequestMsgType request = builder.buildForAdviser(gcmId, Attribute.ADVISER, serviceErrors);
        CreateOTPPartyDetailsType partyDetails = request.getPartyDetails();
    ...
    public void shouldSetIntermediaryDetailsAndCommunicationDetailsForAdviser() throws Exception {
        ...
        assertThat(communicationDetails.getCommunicationMedium(), is(CommunicationMediumType.EMAIL));
        assertThat(communicationDetails.getIntermediaryDetails(), is(notNullValue()));
        assertNull(communicationDetails.getInvestorDetails());
        validateJaxb(request);
    }
