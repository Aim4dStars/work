...
public class CustomerDataDtoConverterTest {
    ...
    @Test
    public void test_getMaskedMobileNumbers_withoutDuplicates() {
        List<Phone> phones = Arrays.asList(getPhone("PHONE", "61", "12341234", "04"), getPhone("PHONE", "61", "12341234", "04"));
        List<PhoneDto> maskedMobiles = CustomerDataDtoConverter.getMaskedAustralianMobileNumbers(phones);
    ...
    private Phone getPhone(String contactMedium, String countryCode, String localNumber, String areaCode) {
        ...
        return new PhoneAdapterV7(phoneAddressContactMethod);
    }
