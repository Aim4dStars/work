...
public class MovemoneyDtoErrorMapperTest {
    private final MovemoneyDtoErrorMapper mapper = new MovemoneyDtoErrorMapperImpl();
    ...
    @Test
    public void testMapWarnings_whenNullWarnings_thenEmptyValidations() {
