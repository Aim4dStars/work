...
import com.bt.nextgen.api.account.v1.service.PaymentLimitDtoServiceImpl;
...
public class PaymentLimitDtoServiceImplTest {
    ...
    public void testUpdateDailyLimit() {
        ...
        payeeDetailsImpl.setPayeeLimits(new ArrayList<PayeeLimit>());
