...
public class OrderDtoServiceTest {
    ...
    public void setup() throws Exception {
        ...
        Mockito.when(orderService.loadOrder(Mockito.any(String.class), Mockito.any(ServiceErrors.class))).thenReturn(orderList);
        Mockito.when(orderService.loadOrders(Mockito.any(SearchParameters.class), Mockito.any(ServiceErrors.class)))
                .thenReturn(orderList);
        Mockito.when(orderService.searchOrders(Mockito.any(String.class), Mockito.any(ServiceErrors.class)))
                .thenReturn(orderList);
    }
    ...
    private Order getJbhShareOrder() {
        ...
        jbhShareOrder.setOrigin(Origin.WEB_UI);
    ...
    public void testToOrderDto_sizeMatches() {
        ...
        Assert.assertEquals(9, managedOrder.size());
    }
    ...
    @Test
    public void testToOrderDto_whenFullRedemptionAndNotCompleted_thenNullAmount() {
        List<OrderDto> managedOrder = orderDtoService.toOrderDtos(orderList, new ServiceErrorsImpl());
        Assert.assertNotEquals(OrderStatus.COMPLETED.getCode(), managedOrder.get(1).getStatus());
        Assert.assertEquals(OrderType.FULL_REDEMPTION, orderList.get(1).getOrderType());
        Assert.assertNull(managedOrder.get(1).getAmount());
        Assert.assertEquals(OrderStatus.IN_PROGRESS.getDisplayName(), managedOrder.get(2).getStatus());
        Assert.assertEquals(OrderType.FULL_REDEMPTION_F.getDisplayName(), managedOrder.get(2).getOrderType());
        Assert.assertNull(managedOrder.get(2).getAmount());
    }
    ...
    public void testUpdateOrder() {
        ...
        Mockito.doNothing().when(orderServiceMock).cancelOrder(Mockito.any(BigInteger.class), Mockito.any(BigInteger.class),
    ...
    public void testToOrderDto_whenShareAssetOrderConverted_thenDetailsMatch() {
        ...
        for (Order jbhShareOrder : orderList.subList(5, 9)) {
            ...
            Assert.assertEquals(filledQuantity, jbhShareOrderDto.getFilledQuantity());
    ...
    public void testCancelOrder_whenNotShareOrder_thenCancelOrderIsCalled() {
        ...
        OrderIntegrationService orderServiceMock = mock(OrderIntegrationService.class);
        Mockito.doNothing().when(orderServiceMock).updateStexOrder(Mockito.any(Order.class), Mockito.any(ServiceErrors.class));
        orderDto = orderDtoService.update(orderDto, serviceErrors);
        Mockito.verify(orderService).cancelOrder(Mockito.any(BigInteger.class), Mockito.any(BigInteger.class),
                Mockito.any(ServiceErrors.class));
    ...
    public void testCancelLSOrder_whenCancellableIsFalse_thenCancelOrderIsCalled() {
        ...
        Mockito.when(orderService.loadOrder(Mockito.any(String.class), Mockito.any(ServiceErrors.class)))
        ...
        Mockito.verify(orderService, Mockito.times(2)).cancelOrder(Mockito.any(BigInteger.class), Mockito.any(BigInteger.class),
                Mockito.any(ServiceErrors.class));
    ...
    public void testCancelLSOrder_whenStatusIsInProgressSentToFundManager_thenUpdateStexOrderIsCalled() {
        ...
        OrderDto returnedOrderDto = orderDtoService.update(orderDto, serviceErrors);
        Mockito.verify(orderService).updateStexOrder(Mockito.any(Order.class), Mockito.any(ServiceErrors.class));
    ...
    public void testUpdateLSOrder_whenOrderIsOpen_thenUpdateStexOrderIsCalled() {
        ...
        Mockito.verify(orderService, Mockito.times(2)).updateStexOrder(Mockito.any(Order.class),
                Mockito.any(ServiceErrors.class));
        Assert.assertFalse(serviceErrors.hasErrors());
        Assert.assertNotNull(shareOrderDto);
        ...
        Mockito.verify(orderService, Mockito.times(3)).updateStexOrder(Mockito.any(Order.class),
                Mockito.any(ServiceErrors.class));
        Assert.assertFalse(serviceErrors.hasErrors());
        Assert.assertNotNull(shareOrderDto);
    }
