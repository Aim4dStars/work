...
public class SubAccountNetReturnChartDtoServiceTest
{
	@InjectMocks
	private SubAccountNetReturnChartDtoServiceImpl netReturnChartService;
	...
	public void testGetWeeklyPerformanceChartDto()
	{
		...
		AccountPerformanceKey key = new AccountPerformanceKey(EncodedString.fromPlainText("31442").toString(),
			...
			endDate,
			"1234");
		AccountNetReturnChartDto chartDto = netReturnChartService.find(key, new ServiceErrorsImpl());
	...
	public void testGetMonthlyPerformanceChartDto()
	{
		...
		accountPerformance.setDailyPerformanceData(monthly);
		accountPerformance.setStartDate(startDate);
		accountPerformance.setEndDate(endDate);
