...
public class ExposureAggregatorTest {
    ...
    public void Start() {
        ...
        AllocationByExposureDto haExp = new HoldingAllocationByExposureDto(getCashAsset(), BigDecimal.valueOf(10),
                BigDecimal.valueOf(20), true, "ext source", allocMap);
    ...
    public void testAggregateAllocations_whenSuppliedWithListWithCash_thenAgregatedAllocationReturned() {
        ...
        Assert.assertEquals(BigDecimal.valueOf(80), dto.getBalance());
        Assert.assertEquals(BigDecimal.valueOf(0), dto.getInternalBalance());
        Assert.assertEquals(BigDecimal.valueOf(80), dto.getExternalBalance());
        ...
        for (AllocationByExposureDto allocation : allocations) {
            ...
            Assert.assertEquals(BigDecimal.valueOf(80), allocation.getBalance());
            Assert.assertEquals(BigDecimal.valueOf(0), allocation.getInternalBalance());
            Assert.assertEquals(BigDecimal.valueOf(80), allocation.getExternalBalance());
