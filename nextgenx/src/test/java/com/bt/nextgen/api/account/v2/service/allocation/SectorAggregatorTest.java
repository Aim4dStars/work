...
public class SectorAggregatorTest {
    ...
    public void Start() {
        ...
        AllocationBySectorDto haSect = new HoldingAllocationBySectorDto(getCashAsset(), "ext source", BigDecimal.valueOf(10),
                BigDecimal.valueOf(20), BigDecimal.valueOf(50), false, true);
