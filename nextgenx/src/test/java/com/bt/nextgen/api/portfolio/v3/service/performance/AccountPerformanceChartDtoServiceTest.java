...
public class AccountPerformanceChartDtoServiceTest {
    ...
    public void testGetColHeaders() {
        ...
        AccountPerformanceDto accountPerformance = performanceChartService.find(key, new ServiceErrorsImpl());
    ...
    public void testGetAccountPerformance() {
        ...
        Assert.assertNotNull(accountPerformance.getPortfolioValueSummary());
        Assert.assertNotNull(accountPerformance.getPeriodDollar());
        ...
        AccountPerformanceDto accountPerformance1 = performanceChartService.find(key1, new ServiceErrorsImpl());
        ...
        Assert.assertNotNull(accountPerformance1.getPortfolioValueSummary());
        ...
        AccountPerformanceDto accountPerformance2 = performanceChartService.find(key2, new ServiceErrorsImpl());
        ...
        Assert.assertNotNull(accountPerformance2.getPortfolioValueSummary());
