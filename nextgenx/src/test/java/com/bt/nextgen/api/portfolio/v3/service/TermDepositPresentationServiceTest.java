...
public class TermDepositPresentationServiceTest {
    ...
    public void setup() {
        ...
        TermDepositInterestRate termDepositInterestRate = new TermDepositInterestRateImpl.TermDepositInterestRateBuilder().withTerm(new Term("6M")).withPaymentFrequency(PaymentFrequency.AT_MATURITY).buildTermDepositRate();
        Mockito.when(
                assetIntegrationService.loadTermDepositRates(Mockito.any(TermDepositAssetRateSearchKey.class),
                        Mockito.any(ServiceErrors.class))).thenReturn(new ArrayList<>(Collections.singleton(termDepositInterestRate)));
    ...
    @Test
    public void testGetTermDepositPresentation_WithNullValues() {
        when(featureToggles.getFeatureToggle(FeatureToggles.TERMDEPOSIT_TOGGLE)).thenReturn(false);
        TermDepositPresentation termDepositPresentation = termDepositPresentationService.getTermDepositPresentation(null,
                assetId, new ServiceErrorsImpl());
        assertNotNull(termDepositPresentation.getPaymentFrequency());
        assertEquals(termDepositPresentation.getPaymentFrequency(),"at maturity");
    }

    @Test
    public void testGetTermDepositPresentation_WithNullValues_02() {
        when(featureToggles.getFeatureToggle(FeatureToggles.TERMDEPOSIT_TOGGLE)).thenReturn(false);
        TermDepositPresentation termDepositPresentation = termDepositPresentationService.getTermDepositPresentation(null,
    ...
    @Test
    public void testGetTermDepositPresentation_WithNullValues_03() {
    ...
    @Test
    public void testGetTermDepositPresentation_ForNewTD() {
        when(featureToggles.getFeatureToggle(FeatureToggles.TERMDEPOSIT_TOGGLE)).thenReturn(true);
        TermDepositPresentation termDepositPresentation = termDepositPresentationService.getTermDepositPresentation(accountKey,
                assetId, new ServiceErrorsImpl());
    ...
    @Test
    public void testGetTermDepositPresentation_ForNewTD_WithNullValues() {
        when(featureToggles.getFeatureToggle(FeatureToggles.TERMDEPOSIT_TOGGLE)).thenReturn(true);
        TermDepositPresentation termDepositPresentation = termDepositPresentationService.getTermDepositPresentation(null,
                assetId, new ServiceErrorsImpl());
    ...
    @Test
    public void testGetTermDepositPresentation_ForNewTD_WithNullAsset() {
        when(featureToggles.getFeatureToggle(FeatureToggles.TERMDEPOSIT_TOGGLE)).thenReturn(true);
        TermDepositPresentation termDepositPresentation = termDepositPresentationService.getTermDepositPresentation(accountKey,
                null, new ServiceErrorsImpl());
        assertNotNull(termDepositPresentation.getPaymentFrequency());
