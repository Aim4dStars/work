...
public class MFValuationAggregatorTest {
    ...
    public void setup() {
        ...
        Mockito.when(mfaDtoService.getAvailableDistributionMethod(Mockito.any(Asset.class)))
                .thenReturn(methods);
    }
    ...
    public void testBuildValuationDto_whenMFSubAccountPassed_thenMFValuationDtosCreated() {
        ...
        List<InvestmentValuationDto> dtoList = mfValuationAggregator.getManagedFundValuationDtos(subAccount, accountBalance);
