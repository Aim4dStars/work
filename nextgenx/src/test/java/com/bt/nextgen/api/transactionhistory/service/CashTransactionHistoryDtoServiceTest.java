...
public class CashTransactionHistoryDtoServiceTest {
    @InjectMocks
    ...
    public void testGetCashTransactionHistory() {
        ...
        index = 0;
        checkDto("dto[" + index + "]", dtos.get(index), transactions.get(index), "lump_sum", "Deposit", null);

        index = 1;
        checkDto("dto[" + index + "]", dtos.get(index), transactions.get(index), "cannotbemarked", "Reversal - Deposit", null);

        index = 2;
        checkDto("dto[" + index + "]", dtos.get(index), transactions.get(index), "cannotbemarked", "Deposit", null);

        index = 3;
        checkDto("dto[" + index + "]", dtos.get(index), transactions.get(index), "unmarked", "Payment", null);

        index = 4;
        checkDto("dto[" + index + "]", dtos.get(index), transactions.get(index), "", "Contribution", "Personal");
    }
    ...
    private List<TransactionHistory> makeTransactionHistories() {
        ...
        retval.add(makeTransactionHistory(CashCategorisationType.LUMP_SUM,
                ...
                false, "Optional desc", new DateTime("2015-01-31"), null, "Advice description", Origin.WEB_UI, null));
        ...
        retval.add(makeTransactionHistory(null, "69950", new BigDecimal(2344), null,
                ...
                false, "Deposit", new DateTime("2015-01-31"), "-36", null, null, null));
        ...
        retval.add(makeTransactionHistory(null, "99808", new BigDecimal(223), new BigDecimal(2333),
                ...
                false, "Optional desc2", new DateTime("2015-03-31"), null, "Advice description2", Origin.WEB_UI, null));
        ...
        retval.add(makeTransactionHistory(null, "99808", new BigDecimal(223), new BigDecimal(2333),
                ...
                "120002211", "262-555", "Tom Demo Bertrand2", "4567", "543", "97876655", "012-029", "deepshikha2",
                false, "Optional desc2", new DateTime("2015-03-31"), null, "Advice description2", Origin.WEB_UI, "Personal"));
    ...
    private void checkDto(String infoStr, CashTransactionHistoryDto dto, TransactionHistory expected,
                          ...
                          String expectedDetailDescription, String expectedSubTypeDescription) {
    ...
    private TransactionHistory makeTransactionHistory(CashCategorisationType cashCategorisationType,
                                                      ...
                                                      Origin origin, String subtypeDescription) {
