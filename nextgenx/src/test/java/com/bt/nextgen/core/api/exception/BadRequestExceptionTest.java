...
public class BadRequestExceptionTest
{
	...
	{
		BadRequestException ex = new BadRequestException(ApiVersion.CURRENT_VERSION);
	...
	{
		BadRequestException ex = new BadRequestException(ApiVersion.CURRENT_VERSION, message);
		assertEquals(ApiVersion.CURRENT_VERSION, ex.getApiVersion());
	...
	{
		BadRequestException ex = new BadRequestException(ApiVersion.CURRENT_VERSION, cause);
		assertEquals(ApiVersion.CURRENT_VERSION, ex.getApiVersion());
	...
	{
		BadRequestException ex = new BadRequestException(ApiVersion.CURRENT_VERSION, message, cause);
		assertEquals(ApiVersion.CURRENT_VERSION, ex.getApiVersion());
		assertEquals(message, ex.getMessage());
		assertEquals(cause, ex.getCause());
	}
