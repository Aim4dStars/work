...
public class PaymentServiceUnitIntegrationTest extends BaseSecureIntegrationTest
{
	...
	{
		GregorianCalendar c = new GregorianCalendar(TimeZone.getTimeZone("Australia/Sydney"));
