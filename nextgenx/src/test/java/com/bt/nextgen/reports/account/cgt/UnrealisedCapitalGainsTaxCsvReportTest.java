...
public class UnrealisedCapitalGainsTaxCsvReportTest {
    @InjectMocks
    private UnrealisedCapitalGainsTaxCsvReport unrealisedCapitalGainsTaxCsvReport;

    @Mock
    private UnrealisedCgtDtoService cgtService;
    ...
    public void testGetCgtData_WithValidResponse() {
        ...
        List<CgtSecurity> cgtSecurityList = unrealisedCapitalGainsTaxCsvReport.getCgtData(params);
